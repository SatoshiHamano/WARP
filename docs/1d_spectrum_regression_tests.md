...
## Python 3.7 Equivalence Check

The committed default/full-mode reference JSON files were generated with the
Python 3.13 PyRAF test environment.  They were then checked against outputs
generated by the established Python 3.7 Astroconda/PyRAF environment:

- Python: `/Users/hamano/miniconda3/envs/astro37/bin/python`
- IRAF: `/Users/hamano/iraf/iraf-2.17.1/`
- `IRAFARCH=macos64`

The following Python 3.7 outputs matched the committed Python 3.13-generated
references after normalizing only the non-scientific output root directory name:

- WIDE 4 Ari default mode: 164 final 1D spectra
- WIDE 4 Ari parameter-file mode: 164 final 1D spectra
- HIRES-J 21 Peg default mode: 196 final 1D spectra
- HIRES-Y HD 163336 default mode: 212 final 1D spectra

This means the current Python 3.13 reference files are also verified against the
previously used Python 3.7 reduction environment for these final 1D spectrum
products.
